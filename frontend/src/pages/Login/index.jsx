        ...
        <>
          {user && <Navigate to='/User'/>}
            ...
            <div className='border shadow-md p-6 w-80 bg-white rounded-sm'>
                ...
                <p className='align-baseline font-medium mt-4 text-md text-center'>Don't have an account? <Link to="/Signup"><span className='text-blue-500 hover:text-blue-700 cursor-pointer ml-1'>Signup</span></Link></p>
            </div>
        </div>
        </>
